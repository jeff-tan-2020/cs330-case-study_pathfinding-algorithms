...
class Driver:
    def __init__(self, date_time, source_lat, source_lon, node):
        ...
        self.source_lon = source_lon
        self.node = node
        self.profit = 0 #If profit low, more likely driver stay on
        self.rides = 0 #If rides high, more likely driver get off
        self.total_time = 0 #If total time spend on app high, more likely driver get off
    def __lt__(self, other):
        return self.date_time < other.date_time
